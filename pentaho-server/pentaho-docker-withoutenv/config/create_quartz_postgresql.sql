...
drop user if exists $PENTAHOUSERTOREPLACE;

CREATE USER $PENTAHOUSERTOREPLACE PASSWORD '$PENTAHOUSERPASSWORDTOREPLACE';

CREATE DATABASE quartz  WITH OWNER = $PENTAHOUSERTOREPLACE  ENCODING = 'SQL_ASCII' TABLESPACE = pg_default;

GRANT ALL ON DATABASE quartz to $PENTAHOUSERTOREPLACE;
...
ALTER TABLE qrtz5_job_listeners OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_trigger_listeners OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_fired_triggers OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_paused_trigger_grps OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_scheduler_state OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_locks OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_simple_triggers OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_cron_triggers OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_blob_triggers OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_triggers OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_job_details OWNER TO $PENTAHOUSERTOREPLACE;
ALTER TABLE qrtz5_calendars OWNER TO $PENTAHOUSERTOREPLACE;
