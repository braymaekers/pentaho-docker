...
define(function() {
  ...
  var ANALYZER_OPTIONS_ANNOTATION = "pentaho/analyzer/visual/Options";
  ...
  var rules = [
    ...
    // All Stock Vizs
    {
      ...
      select: {
        application: [ANALYZER_APP_ID, DASHBOARD_DESIGNER_APP_ID],
        module: "pentaho/visual/models/Abstract"
      },
      apply: {
        isBrowsable: true,
...

    {
      ...
      select: {
        application: [ANALYZER_APP_ID, DASHBOARD_DESIGNER_APP_ID],
        module: "pentaho/visual/models/Abstract",
        annotation: ANALYZER_OPTIONS_ANNOTATION
      },
      deps: ["./config.helper"],
    ...
    },
    {
      ...
      deps: ["pentaho/i18n!pentaho/analyzer/resources/messages"],
        ...
        return {
          ...
          props: {
            ...
            "emptySlicesHidden": {
              ...
              application: {
                // Beware, custom Analyzer configuration.
